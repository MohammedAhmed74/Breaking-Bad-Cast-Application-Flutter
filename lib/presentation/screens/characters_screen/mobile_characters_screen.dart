...
class MobileCharactersScreen extends StatefulWidget {
  const MobileCharactersScreen({Key? key}) : super(key: key);

  @override
  State<MobileCharactersScreen> createState() => _MobileCharactersScreenState();
}

class _MobileCharactersScreenState extends State<MobileCharactersScreen> {
    ...
    return Container(
      ...
      child: GridView.builder(
        ...
        itemBuilder: (context, index) => searchCtrl.text.isEmpty &&
            ...
            ? CharacterItem(
                characters:
                    allCharacters, characretIndex: index,) // presentation/widgets/CharacterItem
            : CharacterItem(
